...
func TestErrorToResponse(t *testing.T) {
	cases := []struct {
		...
		{"collection not empty", stores.ErrCollectionNotEmpty, rocco.ErrConflict},
		{"collection name taken", stores.ErrCollectionNameTaken, rocco.ErrConflict},
		{"collection cycle", stores.ErrCollectionCycle, rocco.ErrConflict},
